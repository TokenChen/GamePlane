# GamePlane
**通过自定义View实现的Android微信打飞机游戏，支持API Level 22+。原作地址：[ISprint GamePlane](https://github.com/iSpring/GamePlane)！**
我的修改：增加本地音频识别库，通过声音能量控制单列子弹，双列子弹，炸弹效果的触发.

游戏说明
----

 1. 声音阈值低于50（环境噪音）此时默认不发射子弹。大于50小于70，发射单列子弹。大于70小于95，发射双列子弹。95以上触发炸弹效果。
